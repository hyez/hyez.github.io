...
- o ∈ O, r ∈ R
    <img src='/assets/posts/스크린샷_2021-10-24_오후_10.50.19.png' width=300>
...
- support set으로 task-specific parameter update, query set으로 gloabl θ update
    ...
    <img src='/assets/posts/스크린샷_2021-10-24_오후_11.02.33.png' width=300>
...
- for `query set`
    ...
    - 단, support set의 rated item set과 query set의 rated item set은 exclusive
        ...
        <img src='/assets/posts/스크린샷_2021-10-25_오후_4.36.20.png' width=300>
...
- `preference prediction` (=estimate the rating score)
    <img src='/assets/posts/스크린샷_2021-10-25_오후_4.45.15.png' width=300>
    
    - **MLP** is a two-layer multilayer perceptron
    - **⊕** denotes concatenation
- `loss`
    <img src='/assets/posts/스크린샷_2021-10-25_오후_4.46.27.png' width=300>
...
1. **Semantic-wise Adaptation. (φ 관점)**
    ...
    - gradient descent step
        <img src='/assets/posts/스크린샷_2021-10-25_오후_5.03.09.png' width=300>
...
2. **Task-wise Adaptation. (ω 관점)**
    ...
    - gradient descent step
        <img src='/assets/posts/스크린샷_2021-10-25_오후_5.03.05.png' width=300>
